...
paths = ['../../data/H300-C5-G4/main_hubheight.nc',
         '../../data/H500-C5-G4/main_hubheight.nc',
         '../../data/H1000-C5-G4/main_hubheight.nc',
         '../../data/H500-C5-G4_aligned/main_hubheight.nc',
         '../../data/H500-C5-G4_double_spacing/main_hubheight.nc',
         '../../data/H500-C5-G4_half_farm/main_hubheight.nc']
xf = np.array([17000,17000,17000,17000,17000,17000]) # x-position of first turbine [m]
flows = {}
